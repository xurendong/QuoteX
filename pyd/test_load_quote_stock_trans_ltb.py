...
#result = LoadQuoteStockTransLTB.LoadQuote(file_path, file_head, file_code, data_code, "", list_info, dict_data) # 注意内存哦
result = LoadQuoteStockTransLTB.LoadQuote(file_path, file_head, file_code, data_code, "600000, 000001", list_info, dict_data)
