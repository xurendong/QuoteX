...
#result = LoadQuoteIndexSnapTDF.LoadQuote(file_path, file_head, file_code, data_code, "", list_info, dict_data) # 注意内存哦
result = LoadQuoteIndexSnapTDF.LoadQuote(file_path, file_head, file_code, data_code, "999999, 399001, 399300", list_info, dict_data)
